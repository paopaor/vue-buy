        ...
        <div class="col-sm-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <p>
                        Bootstrap优站精选频道收集了众多基于 Bootstrap 构建、设计精美的、有创意的网站。 </p>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="well">
                                <h3>
                                    默认效果 </h3> 把 Well 用在元素上，能有嵌入（inset）的的简单效果。
                            </div>
                            <div class="well well-lg">
                                <h3>
                                    可选类 </h3> 通过.well-lg，.well-sm可选修饰类，可以控制此组件的内补（padding）和圆角的设置。
                            </div>
                        </div>
                    </div>
                </div>
